...
project = u'openADS 4.11'
copyright = u'2013-2019, openMairie'
...
latex_documents = [
  ('index', 'openads.tex', u'openADS Documentation',
   u'openMairie', 'manual'),
]
...
man_pages = [
    ('index', 'openads', u'openADS Documentation',
     [u'openMairie'], 1)
]
